...
docker run -d --network=host --name=9hits 9hitste/app /nh.sh --token=313a0768f0f04d266479a05369bd78a3 --system-session --bulk-add-proxy-type=ssh --bulk-add-proxy-list="12.24.45.56;user;pass|my-ssh.com;admin;12345" --allow-crypto=no --session-note=my-ssh --note=my-vps --hide-browser
